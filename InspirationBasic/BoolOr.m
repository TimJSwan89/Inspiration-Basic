...
-(bool) evaluateAgainst:(EnvironmentModel *)environment {
    ...
    if ([ProgramException checkExceptionWithEnvironment:environment andIdentifier:@"BoolOr Expression 1"])
        return false;
    ...
    if ([ProgramException checkExceptionWithEnvironment:environment andIdentifier:@"BoolOr Expression 2"])
        return false;
